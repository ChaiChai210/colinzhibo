...
public abstract class AbVideoFragment extends BaseFragment implements SuperPlayerView.OnSuperPlayerViewCallback, SuperPlayerView.OnPlayEvent {
    ...
    protected void playVideo(String url, String title, int position) {
        mSuperPlayerView.setmCurrentPlayState();
        removeParentView();
...
//                FrameLayout playerContainer = view.findViewById(R.id.fl_video);
//                View v = playerContainer.getChildAt(0);
//                if (v != null && v == mSuperPlayerView) {
//                    if (mSuperPlayerView.isPlaying()) {
...
//                                mSuperPlayerView.resetPlayer();
    ...
    protected abstract void publishPlayCount();
    ...
    public void onFinish() {
        saveRecord(mCurrentPosition);
    }


    private void saveRecord(int pos) {
        if (isSave) {
            watchRecordRepository.insert(getWatchRecord(pos, mSuperPlayerView.getmCurrentTimeWhenPause()));
        }
    }
