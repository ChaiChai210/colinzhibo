...
public abstract class AbsChatLayout extends ChatLayoutUI implements IChatLayout {
    ...
    private ChatProvider.TypingListener mTypingListener = new ChatProvider.TypingListener() {
        ...
        public void onTyping() {
            ...
            getTitleBar().getMiddleTitle().setText(com.tencent.qcloud.tim.uikit.R.string.typing);
...
//        getMessageLayout().setLeftChatContentFontColor(Color.parseColor("#27203D"));
//        getMessageLayout().setRightChatContentFontColor(R.color.black);
        initListener();
    }
