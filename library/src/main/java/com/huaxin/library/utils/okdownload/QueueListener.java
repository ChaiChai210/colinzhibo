...
public class QueueListener extends DownloadListener1 {
    ...
    void resetInfo(DownloadTask task, QueueRecyclerAdapter.QueueViewHolder holder) {
        ...
        if (status != null) {
            Logger.d(holder.tv_title.getText().toString() + "   status:" + status);
            //   started
            ...
            if (status.equals(DownloadManager.COMPLETED)) {
                holder.tv_download.setText(R.string.play);
            ...
            Logger.d(holder.tv_title.getText().toString() + "   non-started:" + statusOnStore.toString());
    ...
    public void taskEnd(@NonNull DownloadTask task, @NonNull EndCause cause,
        ...
        if (cause == EndCause.CANCELED) {
            ...
            Logger.d("realCause:" + realCause.getMessage());
