...
public class TCVodControllerLarge extends TCVodControllerBase
    ...
    private void initViews(Context context) {
        ...
        mContext = context;
        mLayoutInflater.inflate(R.layout.controller_large, this);
...
//    }
    ...
    public void updateVttAndImages(TCPlayImageSpriteInfo info) {
        ...
        if (mPlayType == SuperPlayerConst.PLAYTYPE_VOD) {
            ...
            if (info != null) {
                // 雪碧图ELK上报
                TCLogReport.getInstance().uploadLogs(TCPlayerConstants.ELK_ACTION_IMAGE_SPRITE, 0, 0);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        // 加载点播缩略图
        if (fromUser && mPlayType == SuperPlayerConst.PLAYTYPE_VOD) {
    ...
    public void onSeekBarPointClick(final View view, final int pos) {
        ...
        if (mTXPlayKeyFrameDescInfos != null) {
            //ELK点击上报
            TCLogReport.getInstance().uploadLogs(TCPlayerConstants.ELK_ACTION_PLAYER_POINT, 0, 0);
            mSelectedPos = pos;
