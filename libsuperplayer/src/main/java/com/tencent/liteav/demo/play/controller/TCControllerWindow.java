 ...
 *
 * 2、进度条事件监听{@link #onProgressChanged(SeekBar, int, boolean)}
 *                {@link #onStartTrackingTouch(SeekBar)}
 *                {@link #onStopTrackingTouch(SeekBar)}
 */
public class TCControllerWindow extends RelativeLayout implements IController, View.OnClickListener,
    ...
    private void initView(Context context) {
        ...
        mIvPause = (ImageButton) findViewById(R.id.iv_pause);
