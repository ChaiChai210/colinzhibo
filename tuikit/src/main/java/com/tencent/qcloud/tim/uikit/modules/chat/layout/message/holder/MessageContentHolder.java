...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    public int dp2px(float value) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                value, rootView.getResources().getDisplayMetrics());
    }
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        if (properties.getAvatar() != 0) {
            ...
            leftUserIcon.setDefaultImageResId(R.drawable.ic_avatar);
            rightUserIcon.setDefaultImageResId(R.drawable.ic_avatar);
        }
        if (properties.getAvatarRadius() != 0) {
            ...
            leftUserIcon.setRadius(dp2px(20));
            rightUserIcon.setRadius(dp2px(20));
        }
...
//                msgContentFrame.setBackgroundResource(R.drawable.chat_bubble_myself);
                msgContentFrame.setBackgroundResource(R.drawable.bg_right_text);
            }
        } else {
            if (properties.getLeftBubble() != null && properties.getLeftBubble().getConstantState() != null) {
                ...
                msgContentFrame.setBackgroundResource(R.drawable.bg_left_text);
            }
        }
