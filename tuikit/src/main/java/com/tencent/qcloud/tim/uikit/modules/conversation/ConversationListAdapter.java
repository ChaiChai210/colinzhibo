...
import com.tencent.qcloud.tim.uikit.modules.conversation.holder.ConversationNewHolder;
...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ConversationInfo.TYPE_CUSTOM) {
            ...
            view = inflater.inflate(R.layout.conversation_new_adapter, parent, false);
            holder = new ConversationNewHolder(view);
        }
        if (holder != null) {
