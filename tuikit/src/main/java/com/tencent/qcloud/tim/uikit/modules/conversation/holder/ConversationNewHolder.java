...
public class ConversationNewHolder extends ConversationBaseHolder {
...
//    protected TextView unreadText;
    ...
    public ConversationNewHolder(View itemView) {
        super(itemView);
...
//        }
        ...
        if (conversation.getIconUrlList() != null) {
            Glide.with(conversationIconView.getContext()).load(conversation.getIconUrlList().get(0)).into(conversationIconView);
//            conversationIconView.setImageURI();
        }
