...
import com.huaxin.usercenter.fragment.UserFansFrg;
import com.huaxin.usercenter.fragment.UserFollowFrg;
...
@Route(path = ARConstants.PATH_USER_FOLLOW)
public class UserFollowActivity extends BaseActivity implements VideoNavigatorAdapter.OnItemClickListener {
    ...
    protected void loadData() {
        pos = getIntent().getIntExtra(Constant.KEY_USER_ID, pos);
    ...
    protected void initView(@Nullable Bundle savedInstanceState) {
        ...
        mTitles = ArrayUtils.asArrayList(getResources().getStringArray(R.array.follow_tabs));
        mChildFragments.add(new UserFollowFrg());
        mChildFragments.add(new UserFansFrg());
